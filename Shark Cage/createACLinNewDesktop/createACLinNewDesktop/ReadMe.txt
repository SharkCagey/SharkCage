========================================================================
    APLICACIÓN DE CONSOLA: createACLinNewDesktop Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación createACLinNewDesktop.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación createACLinNewDesktop.


createACLinNewDesktop.vcxproj
...
createACLinNewDesktop.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado createACLinNewDesktop.pch y un archivo de tipos precompilados llamado StdAfx.obj.

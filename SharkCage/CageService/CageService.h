...
public:
	...
	*
	* @param session_id The sessionId of the user.
	...
	*/
	 ...
	 *
	 * @param app_name The path to the execuatble.
	 * @param session_id The sessionId of the user.
	 * @return The process ID of the started process.
	 */
	 ...
	 *
	 * @param app_name The path to the executable.
	 * @param desktop_name The name of the desktop to start the program in.
	 * @param session_id The sessionId of the user.
	 * @return The process ID of the started process.
	 */

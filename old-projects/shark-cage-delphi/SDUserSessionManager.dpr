        ...
        sdpIdle:
          begin
            ...
            begin
              ...
              SI.cb := SizeOf(SI);
              Windows.GetUserObjectInformation(hUserDesktop, UOI_NAME, nil, 0, dwLengthNeeded);
              GetMem(szDesktopName, dwLengthNeeded);
              Windows.GetUserObjectInformation(hUserDesktop, UOI_NAME, szDesktopName, dwLengthNeeded, dwLengthNeeded);
              Log(Format('szDesktopName (%d): %s', [dwLengthNeeded, StrPas(szDesktopName)]));
              SI.lpDesktop := szDesktopName;
              Windows.CreateProcess(PChar(ExtractFilePath(ParamStr(0)) + 'SDPrepareSwitch.exe'),
            ...
            begin
              ...
              if (SDAppInfoApplicationExecutable(cApplicationId) <> '') then
            ...
            begin
              // Adjust ACL for secure desktop
              // Terminate processes that have threads attached to the secure desktop

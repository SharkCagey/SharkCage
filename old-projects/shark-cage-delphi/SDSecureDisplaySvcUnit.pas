...
type
  TSDSecureDisplayService = class(TService)
    timSafetyTimer: TTimer;
    procedure ServiceExecute(Sender: TService);
    procedure ServiceAfterInstall(Sender: TService);
    procedure timSafetyTimerTimer(Sender: TObject);
  private
...
procedure TSDSecureDisplayService.timSafetyTimerTimer(Sender: TObject);
begin
  FCurrentState := sdpHideApplication;
  timSafetyTimer.Enabled := false;
end;
    ...
    case FCurrentState of
      ...
      sdpShowApplication:
        begin
          ...
          // Sleep(8000);
          // FCurrentState := sdpHideApplication;
          timSafetyTimer.Interval := 30*1000;
          timSafetyTimer.Enabled := true;
          FCurrentState := sdpIdle;
        end;
      sdpHideApplication:
        begin
